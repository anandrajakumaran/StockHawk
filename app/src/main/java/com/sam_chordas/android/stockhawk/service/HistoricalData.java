...
public class HistoricalData {
    ...
    ArrayList<StockParcelable> stockParcelables;
    ...
    public void getHistoricalData(String symbol) {
        ...
        final StringRequest request = new StringRequest(
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        if (response != null) {
                            stockParcelables = new ArrayList<>();
                            try {
                                ...
                                for (int i = 0; i < series_data.length(); i += 10) {
                                    ...
                                    stockParcelables.add(new StockParcelable(date, close));
                                }
                                if (callback != null) {
                                    setHistoricalDataStatus(STATUS_OK);
                                    callback.onSuccess(stockParcelables);
                                }
        ...
        StockController.getInstance().addToRequestQueue(request, TAG);
    }
    ...
    public void setHistoricalDataStatus(@HistoricalDataStatuses int status) {
        ...
        editor.putInt(context.getString(R.string.historicalCalltatus), status);
        editor.apply();
    }
    ...
    public interface HistoricalDataCallback {
        void onSuccess(ArrayList<StockParcelable> list);
        void onFailure();
    }
}